...
namespace GEDmill.ImageClasses
{
    ...
    // Each box consists of text surrouned by PADDING surrouned by a single line
    ...
    public class CMiniTreeIndividual : CMiniTreeObject
    {
        ...
        // Accessor for left side position of box area.
        public float Left
        {
            get
            {
        ...
        // Accessor for right side position of box area.
        public float Right
        {
            get
            {
        ...
        // Accessor for top side position of box area.
        public float Top
        {
            get
            {
        ...
        // Accessor for bottom side position of box area.
        public float Bottom
        {
            get
            {
        ...
        // The vertical centre of the box, where the tee line between boxes should attach.
        ...
        // The left edge of the box, where the tee line between boxes should attach.
        ...
        // The right edge of the box, where the tee line between boxes should attach.
        ...
        // Caller should call HasStalk first to ensure result from this property is valid.
        // The horizontal centre of the box, where the tee line up to frParents should attach.
        public float Stalk
        {
            get
            {
        ...
        // Returns true if this box needs a line drawing up to a parent.
