...
namespace GEDmill.ImageClasses
{
  ...
  {
    // Type of line joining this box horizontally to indicate marriage or other parenting relationship.
    ...
    // Width of the line joining this group to group above.
    private const float TEE_WIDTH = 0.0f;

    // Height of the line joining this group to group above.
    ...
    // Returns the left-most box. (Used when drawing horizontal line from which children hang.)
    ...
    // Returns the right-most box. (Used when drawing horizontal line from which children hang.)
    ...
    // Returns minimum and maximum x coordinate for an upwards line from this group's crossbar.
